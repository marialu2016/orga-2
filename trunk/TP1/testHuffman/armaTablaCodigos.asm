...
armar_tabla:
                  ...
                  mov ebx, 12;pongo en ebx el tamaño de cada nodo
                  mul ebx;pongo en eax la cantidad de memoria a pedir 
                  push eax
                  call malloc
...
ciclo:
                  cmp esi, [edx + nodo_izq]; me fijo si la hoja es el hijo izquierdo
